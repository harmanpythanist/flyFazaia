...
const services=[{ 
      ...
      description: 'Transform your business with cutting-edge AI and ML solutions. From predictive analytics to neural networks, we build intelligent systems that learn and adapt to your needs.',
      color: 'from-cyan-500 to-indigo-600',
      list: `
        Build and deploy custom AI models,
        Train or tune ML algorithms (hyper-parameter tuning),
        Help with ML project implementation,
        Guidance on "How to make your own AI",
        Integrate AI into apps or websites`
    }];
...
return (  <CoursesSection data={get.data} type="Services"/> )
